...
import os
from tsv_header_adder import get_tsv_with_header

DATA_PATH = r'.\data\20150101.txt'
OUTPUT_IMG_PATH = r'.\output\correlation_matrix.png'
...
selected_columns = ['DURATION', 'SOURCE_BYTES', 'DESTINATION_BYTES', 'COUNT', 'SAME_SRV_RATE', 'SERROR_RATE', 'SRV_SERROR_RATE', 'DST_HOST_COUNT',
                    'DST_HOST_SRV_COUNT', 'DST_HOST_SAME_SRC_PORT_RATE', 'DST_HOST_SERROR_RATE', 'DST_HOST_SRV_SERROR_RATE']
